...
<h1>CedGallery 3.0.1 <?php echo $this->isFree; ?></h1>
...
<div>
    ...
    <div>
        <a href="https://www.galaxiis.com/cedgallery-doc/" target="_blank" title="Documentation"><i class="fa fa-book fa-4x" aria-hidden="true">  Documentation.</i></a>
    </div>
    <div>
    ...
    <div>
        <a href="https://www.galaxiis.com/cedgallery-jed/" target="_blank" title="Joomla JED review"><i class="fa fa-joomla fa-4x" aria-hidden="true"> Joomla JED review.</i></a>
    </div>
    <div>
        <div class="icon">
            <a href="https://www.galaxiis.com/cedgallery-download/" target="_blank" title="Download latest free version">
