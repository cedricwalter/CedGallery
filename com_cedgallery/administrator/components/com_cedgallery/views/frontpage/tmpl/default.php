...
<div class="tagpanel">
    ...
    <div style="float: left;">
        <div class="icon">
            <a href="index.php?option=com_cedgallery&view=liveupdate"
               title="<?php echo JText::_('Live Update');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/update_48x48.png"
    ...
    <div style="float: left;">
        <div class="icon"><a href="https://www.galaxiis.com/" target="_blank"
                ...
                src="<?php echo JUri::root() ?>/media/com_cedgallery/images/galaxiis3.jpg"/>
            <span><?php echo JText::_('HOME');?></span></a>
        </div>
    </div>
    <div style="float: left;">
        <div class="icon"><a
                href="https://www.galaxiis.com/cedgallery-download-doc/"
                target="_blank"
                title="<?php echo JText::_('MANUAL');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedgallery/images/manual.png"/>
    ...
    <div style="float: left;">
        <div class="icon"><a
                ...
                src="<?php echo JURI::root() ?>/media/com_cedgallery/images/forum.png"/>
    ...
    <div style="float: left;">
        <div class="icon"><a
                ...
                src="<?php echo JURI::root() ?>/media/com_cedgallery/images/license.png"/>
        ...
        <div class="icon">
            <a href="http://extensions.joomla.org/extensions/news-display/articles-display/related-items/11491"
               ...
               title="<?php echo JText::_('JED VOTE');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/jed.png"/>
                <span><?php echo JText::_('JED VOTE');?></span></a>
        </div>
    </div>
    <div style="float: left;">
        <div class="icon">
            <a href="https://www.galaxiis.com/cedgallery-download/"
               target="_blank"
               title="<?php echo JText::_('Download');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/download.png"/>
        ...
        <div class="icon">
            <a href="https://www.facebook.com/galaxiiscom"
               ...
               title="<?php echo JText::_('Like on Facebook');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/facebook.png"/>
        ...
        <div class="icon">
            <a href="https://twitter.com/galaxiiscom"
               ...
               title="<?php echo JText::_('Follow Me on Twitter');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/twitter.png"/>
        ...
        <div class="icon">
            <a href="https://plus.google.com/u/0/104558366166000378462"
               ...
               title="<?php echo JText::_('Follow Me on Google+');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedgallery/images/google.png"/>
...
<div class="tagversion">
    ...
    <h1>CedGallery 1.4.1</h1>
        ...
        <a href="https://www.galaxiis.com/subscribe.html" alt="join now" title="join now - get the licensed version of CedGallery and enjoy more customizations and features!" target="_new"><img src="<?php echo JURI::root() ?>/media/com_cedgallery/images/joinnow.png" /></a>
    <p>
